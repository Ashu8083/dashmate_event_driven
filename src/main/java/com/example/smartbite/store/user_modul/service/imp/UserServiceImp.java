...
import com.example.smartbite.store.user_modul.repo.UserAddressRepo;
import com.example.smartbite.store.user_modul.repo.UserDeviceRepo;
import com.example.smartbite.store.user_modul.repo.UserRefreshTokenRepo;
...
public class UserServiceImp implements UserService {
    ...
    @Override
    public UserAddressResponseDTO createUserAddress(UserAddressRequestDTO data) {
        ...
        try {
            storeAddress = userAddressRepo.save(userAddress);
        } catch (Exception e) {

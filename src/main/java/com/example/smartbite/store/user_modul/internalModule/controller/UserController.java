package com.example.smartbite.store.user_modul.internalModule.controller;
...
public class UserController {
    ...
    UserAddressResponseDTO createUserAddressController(@Valid @RequestBody UserAddressRequestDTO data,@RequestParam UUID userId) {
        return userService.createUserAddress(userId,data);
    }

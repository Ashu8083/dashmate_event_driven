...
@Repository
public interface TripRepo extends JpaRepository<Trips, UUID> ,
        TripRepoCustom, JpaSpecificationExecutor<Trips> {
...
""")
    Page<Trips> findByCustomerId(@Param("customerId") UUID customerId,
                                 Pageable pageable);
    ...
    Optional<Trips> findByTripId(@Param("tripId") UUID tripId , Pageable pageable);

    List<Trips> getAllByCustomerId(UUID customerId, Pageable pageable);
